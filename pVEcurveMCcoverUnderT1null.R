...
beta <- getBeta(beta2=0, beta3=0, meanS0=2, varS0=1, meanS1=3, varS1=1, probP=0.1, probV=0.05, rr=1, rr0=0.5, scenario="A2", threshold=1.5)
...
for (i in 1:length(pi)){
  ...
  save(inferenceVE, file=file.path(outDir, paste0("pVE_coverSizePower_coverUnderT1null_ns.df=3_nMC=",nMC,"_N=",n,"_nBoot=",nBoot,"_truncateMarker=",truncateMarker,"_pi=",pi[i],".RData")))
}
